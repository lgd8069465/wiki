...
logout
-- 创建 oracle 安装目录
[root@oa ~]# mkdir -p /opt/oracle/product/11.2.0/db
-- 指定 oracle 用户和群组
[root@oa ~]# chown -R oracle:oinstall /opt/oracle
-- 授权 oracle 安装目录
[root@oa ~]# chmod -R 775 /opt/oracle
-- 验证
[root@oa ~]# ll /opt/oracle
total 4
drwxrwxr-x. 3 oracle oinstall 4096 Jul 26 14:11 product
...
PATH=/usr/lib64/qt-3.3/bin:/usr/local/bin:/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/sbin:/home/oracle/bin:/home/oracle/bin:/bin
PWD=/home/oracle
LANG=en_US.UTF-8
KDE_IS_PRELINKED=1
KDEDIRS=/usr
...
-- root用户先执行下面再点击OK
[root@oa ~]# /home/oracle/oraInventory/orainstRoot.sh
...
[root@oa ~]# /opt/oracle/product/11.2.0/db/root.sh
...
oa:/opt/oracle/product/11.2.0/db:N
